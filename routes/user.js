...
const { registerUser, loginUser, updateUser, deactivateUser, getCustomerProfile, 
    checkCustomerExists, updateUserRole, updateUserStatus, getAllUsers, getSingleUser, createAdmin } = require('../controllers/user')

router.post('/register', registerUser);
router.post('/login', loginUser);
router.post('/update-profile', upload.single('image'), updateUser);
router.post('/deactivate', deactivateUser);
router.get('/customers/:customerId/exists', checkCustomerExists);
